...
<head>
  ...
  <style>
    ...
    .navbar {
      ...
      margin-bottom: 0 !important; /* overrides Bootstrap’s default margin-bottom */
    }
    .navbar .nav-link,
    .navbar .navbar-brand,
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="navLinks">
          ...
          <li class="nav-item">
            <a class="nav-link" href="org_login.php">Hospital Login</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="admin_login.php">Admin Login</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="search.php">Availability</a>
          </li>
          <li class="nav-item">
