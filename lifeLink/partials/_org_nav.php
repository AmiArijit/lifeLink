    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="navLinks">
          ...
          <li class="nav-item">
            <a class="nav-link" href="org_dashboard.php">Dashboard</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="addBloodform.php">Add Blood</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="add_edit_bed_form.php">Add Bed</a>
          </li>
          <li class="nav-item">
